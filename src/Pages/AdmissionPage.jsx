...
const AdmissionPage = () => {
    return(
            ...
            <div className="other" id="other">
                ...
                <p>For detailed information on postgraduate program admissions, specific program syllabi, and fee structures, please visit our <a className="abt" href="http://localhost:5173/courses">Courses page</a> or <a className="abt" href="http://localhost:5173/contact">Contact us</a> directly.</p>
                <br></br>
                <Footer/>
            </div>
    )
